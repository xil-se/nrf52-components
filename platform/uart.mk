...
C_SOURCE_FILES += $(NRF52_SDK)/components/drivers_nrf/uart/nrf_drv_uart.c
C_SOURCE_FILES += $(NRF52_SDK)/components/libraries/uart/app_uart.c
C_SOURCE_FILES += $(NRF52_SDK)/components/libraries/util/app_util_platform.c
C_SOURCE_FILES += $(NRF52_SDK)/components/toolchain/system_nrf52.c
